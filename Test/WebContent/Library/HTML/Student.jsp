...
<body bgcolor=#eee>
<%
	out.println("欢迎您，用户："+session.getAttribute("StuName"));
...
<tr align = center>
<th>图书编号</th><th>图书名称</th><th>基本描述</th><th>借阅状态</th><th>图书数量</th><th>借阅</th>
</tr>
<% 
		...
		out.println("<td>"+"<a href='stuOperation2.jsp?ID="+rs.getInt("BookID")+"&State="+BookState+"'>借阅</a>"+"</td>");
		out.println("</tr>");
		if(!rs.next()) break;
	}
	//con.close();
...
if(pb.getCurrentPage()!=1){
	%>
	<a href="Student.jsp?method=first">第一页</a>
	<a href="Student.jsp?method=previous">上一页</a>
	<%
}
if(pb.getCurrentPage()!=pb.getTotalPages()){
	%>
	<a href="Student.jsp?method=next">下一页</a>&nbsp;
	<a href="Student.jsp?method=last">最后页</a>&nbsp;
	<%
}
%>
</td>
...
<p>
	<a href="BorrowRecord.jsp">查看已借图书</a>
</p>
<p>
